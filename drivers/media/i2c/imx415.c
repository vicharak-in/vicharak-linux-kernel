 ...
 * 1782Mbps
 * Master Mode
 * 3840x2160 crop + H/V 2/2-line binning -> 1920x1080
 */
static __maybe_unused const struct regval imx415_linear_12bit_1920x1080_1782M_regs_2lane[] = {
	{0x3008, 0x5D},
	{0x300A, 0x42},
	{0x301C, 0x04}, /* WINMODE = window crop */
	{0x3020, 0x01}, /* HADD */
	{0x3021, 0x01}, /* VADD */
	...
	/* 10-bit ADC, 12-bit output */
	{0x3031, 0x00},
	{0x3033, 0x04},

	/* 3840x2160 crop -> 1920x1080 after 2x2 binning */
	{0x3040, 0x0C},
	{0x3041, 0x00},
	{0x3042, 0x00},
	{0x3043, 0x0F},
...
static const struct imx415_mode supported_modes_2lane[] = {
	...
	},
	{
		...
		.exp_def = 0x0AA7 - 0x08,
		.hts_def = 0x021A * IMX415_2LANES * 2,
		.vts_def = 0x0AA7,
		.global_reg_list = NULL,
		.reg_list = imx415_linear_12bit_1920x1080_1782M_regs_2lane,
		.hdr_mode = NO_HDR,
		.mipi_freq_idx = 3, /* 891 MHz -> 1782 Mbps/lane */
		.bpp = 12,
		.vc[PAD0] = 0,
		.xvclk = IMX415_XVCLK_FREQ_27M,
	},
